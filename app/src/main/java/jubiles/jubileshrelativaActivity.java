...
public class jubileshrelativaActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle b){
        super.onCreate(b);
        setContentView(R.layout.activity_jubileshrelativa);
        toolbar = (Toolbar) findViewById(R.id.toolbarGen);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        barra = (BarChart) findViewById(R.id.humerdadRelativaJubiles);

        lineChart = (LineChart) findViewById(R.id.humerdadRelativasJubiles);
    ...
    public void inicializandoGraficarUno(){
        data.llenarGrafica1(barra,"jubiles","humedadRelativa");
    }

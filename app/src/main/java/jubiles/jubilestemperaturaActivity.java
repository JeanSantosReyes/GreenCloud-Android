...
public class jubilestemperaturaActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle b){
        super.onCreate(b);
        setContentView(R.layout.activity_jubiles_temperatura);

        toolbar = (Toolbar) findViewById(R.id.toolbarGen);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        barra = (BarChart) findViewById(R.id.temperaturaJubiles);

        lineChart = (LineChart) findViewById(R.id.temperaturasJubiles);
    ...
    public void inicializandoGraficarUno(){
        data.llenarGrafica1(barra,"jubiles","temperatura");
    }

...
public class FragmentGrafica extends Fragment {
    ...
    private String position,type,fueld;
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup group,Bundle bundle){
        ...
        data = new ObtenerDatosGrafica1(grafica1,type,position,"temperatura","",getActivity());
        return view;
    }
    public void updateGrafica(String type,String seccion,String field){
       data = new ObtenerDatosGrafica1(grafica1,type,seccion,field,"",getActivity());
    }
}

...
public class sunburtshsueloActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle){
        ...
        setContentView(R.layout.activity_sunburtshsuelo);
        ...
        barra = (BarChart) findViewById(R.id.humerdadSueloSunburts);

        lineChart = (LineChart) findViewById(R.id.humerdadSuelosSunburts);
    ...
    public void inicializandoGraficarUno(){
        data.llenarGrafica1(barra,"sunburts","humedadSuelo");
    }

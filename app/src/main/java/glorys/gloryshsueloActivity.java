...
public class gloryshsueloActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle){
        ...
        setContentView(R.layout.activity_gloryshsuelo);
        ...
        barra = (BarChart) findViewById(R.id.humerdadSueloGlorys);

        lineChart = (LineChart) findViewById(R.id.humerdadSuelosGlorys);
    ...
    public void inicializandoGraficarUno(){
        data.llenarGrafica1(barra,"glorys","humedadSuelo");
    }

...
public class gloryshrelativaActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle b){
        super.onCreate(b);
        setContentView(R.layout.activity_gloryshrelativa);
        toolbar = (Toolbar) findViewById(R.id.toolbarGen);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        barra = (BarChart) findViewById(R.id.humerdadRelativaGlorys);

        lineChart = (LineChart) findViewById(R.id.humerdadRelativasGlorys);
    ...
    public void inicializandoGraficarUno(){
        data.llenarGrafica1(barra,"glorys","humedadRelativa");
    }
